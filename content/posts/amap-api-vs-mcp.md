...
没接地图 API 之前，AI 会自信地输出完整的通勤方案表格——哪个片区开车多少分钟、地铁多少分钟——看起来很专业，但全是根据「大约每站 2.5-3 分钟」估算的。问它数据来源，才老实交代：
...
注册高德开放平台（个人认证，免费），拿到 Web 服务 Key。用深圳 5 个随机地标做了 14 项 API 全面测试，全部通过。
